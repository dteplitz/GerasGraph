...
PROFESOR_BASE_BY_TYPE = {
    ...
    "tipo_objetivo": (
        ...
        "- Asume una rentabilidad varia entre 6 y 12 porciento anual segun el riesgo que elija el usuario. \n"
    ...
    "objetivo_monto_final": (
        ...
        "- Usá ejemplos prácticos en dólares estadounidenses (USD) para ilustrar posibles objetivos.\n"
    ...
    "objetivo_renta": (
        ...
        "- Usá ejemplos concretos con cifras redondas para orientar al usuario en dólares estadounidenses (USD).\n"
